...
public class Board extends JPanel {
	...
	public class Cell extends JPanel {
		...
		public Cell(Point coord) {
			...
			addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if (e.getButton() == MouseEvent.BUTTON1 && !shipsVisible && GamePlayLogic.turnOrder % 2 == 0 && !(GameplayScreen.gl.bot.getShipLocations().getHitSections().containsKey(coord) || GameplayScreen.gl.bot.getShipLocations().getMisses().contains(coord))) {
		...
		// Will be changed to become more dynamic with the window size, as well as being
		// imported from outside class.
		@Override
